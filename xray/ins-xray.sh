...
rm acme.sh
cd .acme.sh
bash acme.sh --register-account -m farukbrowser234@gmail.com
...
[Unit]
Description=Xray Service Mod By Dendi Kusnandi
...
[Unit]
Description=Trojan-Go Service Mod By Dendi Kusnandi
