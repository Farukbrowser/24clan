...
if [[ $sst_status == "running" ]]; then
  status_sst=" ${GREEN}Running ${NC}( Active )"
else
...
if [[ $ssh_status == "running" ]]; then 
   status_ssh=" ${GREEN}Running ${NC}( Active )"
else
...
if [[ $oovpn == "active" ]]; then
  status_openvpn=" ${GREEN}Running ${NC}( Active )"
else
...
if [[ $squid_service == "running" ]]; then 
   status_squid=" ${GREEN}Running ${NC}( Active )"
else
...
if [[ $vnstat_service == "running" ]]; then 
   status_vnstat=" ${GREEN}Running ${NC}( Active )"
else
...
if [[ $cron_service == "running" ]]; then 
   status_cron=" ${GREEN}Running ${NC}( Active )"
else
...
if [[ $fail2ban_service == "running" ]]; then 
   status_fail2ban=" ${GREEN}Running ${NC}( Active )"
else
...
if [[ $tls_v2ray_status == "running" ]]; then 
   status_tls_v2ray=" ${GREEN}Running${NC} ( Active )"
else
...
if [[ $nontls_v2ray_status == "running" ]]; then 
   status_nontls_v2ray=" ${GREEN}Running ${NC}( Active )${NC}"
else
...
if [[ $vless_tls_v2ray_status == "running" ]]; then
  status_tls_vless=" ${GREEN}Running${NC} ( Active )"
else
...
if [[ $vless_nontls_v2ray_status == "running" ]]; then
  status_nontls_vless=" ${GREEN}Running${NC} ( Active )"
else
...
if [[ $ssr_status == "running" ]] ; then
  status_ssr=" ${GREEN}Running${NC} ( Active )${NC}"
else
...
if [[ $status_text == "active" ]] ; then
  status_sodosok=" ${GREEN}Running${NC} ( Active )${NC}"
else
...
if [[ $trojan_server == "running" ]]; then 
   status_virus_trojan=" ${GREEN}Running ${NC}( Active )${NC}"
else
...
if [[ $swg == "active" ]]; then
  status_wg=" ${GREEN}Running ${NC}( Active )${NC}"
else
...
if [[ $strgo == "active" ]]; then
  status_trgo=" ${GREEN}Running ${NC}( Active )${NC}"
else
...
if [[ $l2tp_status == "running" ]]; then 
   status_l2tp=" ${GREEN}Running${NC} ( Active )${NC}"
else
...
if [[ $dropbear_status == "running" ]]; then 
   status_beruangjatuh=" ${GREEN}Running${NC} ( Active )${NC}"
else
...
if [[ $stunnel_service == "running" ]]; then 
   status_stunnel=" ${GREEN}Running ${NC}( Active )"
else
...
if [[ $sstp_service == "running" ]]; then 
   status_sstp=" ${GREEN}Running ${NC}( Active )"
else
...
if [[ $wstls == "running" ]]; then 
   swstls=" ${GREEN}Running ${NC}( Active )${NC}"
else
...
if [[ $wsdrop == "running" ]]; then 
   swsdrop=" ${GREEN}Running ${NC}( Active )${NC}"
else
...
if [[ $wsovpn == "running" ]]; then 
   swsovpn=" ${GREEN}Running ${NC}( Active )${NC}"
else
...
if [[ $osslh == "running" ]]; then 
   sosslh=" ${GREEN}Running ${NC}( Active )${NC}"
else
...
# STATUS OHP DROPBEAR
if [[ $ohp == "running" ]]; then 
   sohp=" ${GREEN}Running ${NC}( Active )${NC}"
else
...
# STATUS OHP OpenVPN
if [[ $ohq == "running" ]]; then 
   sohq=" ${GREEN}Running ${NC}( Active )${NC}"
else
...
# STATUS OHP SSH
if [[ $ohr == "running" ]]; then 
   sohr=" ${GREEN}Running ${NC}( Active )${NC}"
else
...
if [[ $wsopen == "running" ]]; then 
   swsopen=" ${GREEN}Running ${NC}( Active )${NC}" 
else
...
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "❇️ Client Name    : Anonymous"
echo -e "❇️ Exp Script     : Lifetime"
echo -e "❇️ Version        : Latest Version"
echo -e "❇️ WhatsApp       : 082117696800"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
