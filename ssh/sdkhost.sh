...
subsdk=$(</dev/urandom tr -dc a-z0-9 | head -c5)
DOMAIN=mydendissh.tech
SUB_DOMAIN=crot-${sub}.mydendissh.tech
NS_DOMAIN=slowdns-${subsdk}.mydendissh.tech
CF_ID=farukbrowser234@gmail.com
CF_KEY=64010ace4f4f17290accb956eb4ea1652d5df
set -euo pipefail
